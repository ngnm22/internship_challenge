...
class Rental_price
    ...
    def initialize(car_data,rental_data,option_data) 
        ...
        #finding our actions and options
        @action_rental = Rental_action.new(@price,@commission,option_data,rental_data,@numberofdays)
        @actions = @action_rental.actions
        @options = @action_rental.options
    end
